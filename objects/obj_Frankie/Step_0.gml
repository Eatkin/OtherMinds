...
if (state!=PlayerState.air and state!=PlayerState.onwall and !place_meeting(col_pos,y+1,obj_solid) and !place_meeting(col_pos,y+1,obj_semisolid) and col_pos==clamp(col_pos,0,room_width))
	{
		s_jump=true;
	}
