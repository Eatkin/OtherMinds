...
active=0;
state=PlayerState.idle; //Three states for Jim Signman
label=scr_return_text(160);

//Create the object to control the sign
child=instance_create_layer(x+sprite_width*0.5,y,layer,obj_signman_mask);
child.owner=id; //What a ridiculous choice of variables