...
var target=0;
target[0]=obj_gameplayPausePanel;
target[1]=obj_graphicsPausePanel;
target[2]=obj_audioPausePanel;
target[3]=obj_controlPausePanel;
...
xButtonTarget=480*0.1;
var xx=xButtonTarget+480;
var yy=buttonSpacing;
button=0;
buttonSelected=0;
...
for (i=0; i<len; i+=1)	{
	button[i]=instance_create_layer(xx,yy+buttonSpacing*i,layer,obj_pauseOptionButton);
