...
with (sage)	{
	var text;
	text[0]=scr_return_text(834);
	text[1]=scr_return_text(835);
	text[2]=scr_return_text(836);
	if (scr_inventory_check(obj_key_card_C) and scr_inventory_check(obj_key_card_D))
		text[3]=scr_return_text(837);
