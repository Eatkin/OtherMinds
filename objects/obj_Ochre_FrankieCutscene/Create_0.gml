...
with (sage)	{
	var text;
	text[0]=scr_return_text(730);
	text[1]=scr_return_text(731);
	if (!scr_event_check_complete(global.ochre_events,OCHRE_EVENTS.RESCUEDFRANKIE))
		text[2]=scr_return_text(732);
