...
with (sage)	{
	var text;
	text[0]=scr_return_text(706);
	text[1]=scr_return_text(707);
	text[2]=scr_return_text(708);
	text[3]=scr_return_text(709);
	text[4]=scr_return_text(710);
	text[5]=scr_return_text(711);
